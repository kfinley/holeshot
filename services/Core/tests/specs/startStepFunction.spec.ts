...
describe("startStepFunction", () => {
  ...
  const context = {
    ...
    functionName: 'holeshot-Dev-WebSockets-StartStepFunction',
    functionVersion: '$LATEST',
    identity: undefined,
    invokedFunctionArn: 'offline_invokedFunctionArn_for_holeshot-Dev-WebSockets-StartStepFunction',
    logGroupName: 'offline_logGroupName_for_holeshot-Dev-WebSockets-StartStepFunction',
    logStreamName: 'offline_logStreamName_for_holeshot-Dev-WebSockets-StartStepFunction',
